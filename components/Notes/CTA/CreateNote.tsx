...
export default function CreateNote() {
  return (
    <div className="flex justify-center" role="button">
      <Link
        href="/notes/new"
        className="btn-primary w-full max-w-xl text-center a11y-focus"
      >
        Create Note
        <span className="ml-2">
          <svg
